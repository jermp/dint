    ...
    */
    class compress_integer_qmx_improved
        ...
        public:
            ...
            */
            virtual size_t encode(void *encoded, size_t encoded_buffer_length, const uint32_t *source, size_t source_integers);
            ...
            */
            virtual void decode(uint32_t *decoded, size_t integers_to_decode, const void *source, size_t source_length);
