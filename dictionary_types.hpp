...
namespace ds2i {
    ...
    struct dint_dict_type_DSF
    {
        ...
        //     size_t adjust_sub_sequences(hash_id_map,block,freedom,dictionary,adjust)
        //     {
        //         if(block.entry_len == 1) return 0; // base case

        //         size_t needed = 0;
        //         auto sub_sequences = determine_sub_sequences(hash_id_map,block,block.entry_len);
        //         for(auto& ss : sub_sequences) {
        //             update_count(ss);
        //             needed += adjust_sub_sequences(hash_id_map,ss,freedom,dictionary,adjust)
        //         }
        //         return needed;
        //     }
        ...
        //             // (c) recursively adjust the counts of sub-sequences
        //             needed += adjust_sub_sequences(hash_id_map,block,freedom,dictionary,adjust);
        //         }
