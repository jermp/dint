...
namespace ds2i {
    ...
    struct dictionary_overlapped {
        ...
        struct builder {
            ...
            static const uint32_t num_entries = dictionary_overlapped::num_entries;
            static const uint32_t max_entry_size = dictionary_overlapped::max_entry_size;
            static const uint32_t invalid_index = dictionary_overlapped::invalid_index;
            static const uint32_t reserved = dictionary_overlapped::reserved;
            ...
            void build() {

                {
                    ...
                    auto compacted_targets = compact(targets);
...

                {
                    ...
                    boost::progress_display progress(m_targets.size());
            ...
            void build(dictionary_overlapped& dict) {
        ...
        void swap(dictionary_overlapped& other) {
            m_offsets.swap(other.m_offsets);
            m_table.swap(other.m_table);
        }
