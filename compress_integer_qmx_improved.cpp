...
namespace JASS
    ...
    */
    ...
    /*
        ...
        ---------------------------------------
    */
    size_t compress_integer_qmx_improved::encode(void *into_as_void, size_t encoded_buffer_length, const uint32_t *source, size_t source_integers)
        {
    ...
    */
    void compress_integer_qmx_improved::unittest(void)
        ...
        */
        static std::array<uint8_t, 100'000 * sizeof(uint32_t)> compress_buffer_memory;
        static std::array<uint32_t, 100'000> decompress_buffer_memory;
    ...
    */
    int main(void)
        ...
        printf("\n");
        printf("\tvoid compress_integer_qmx_improved::decode(uint32_t *to, size_t destination_integers, const void *source, size_t len)\n");
        printf("\t\t{\n");
...
namespace JASS
    ...
    void compress_integer_qmx_improved::decode(uint32_t *to, size_t destination_integers, const void *source, size_t len)
        {
