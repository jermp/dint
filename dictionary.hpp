...
namespace ds2i {
    ...
    //         std::tuple<size_t,size_t,size_t> find_largest_overlap(std::vector<overlap_node_t>& entries) const {
    ...
    //                 }
    //             }
    //             return std::make_tuple(max_overlap,max_index_left,max_index_right);
    //         }

    //         void compute_greedy_scs() {
    //             // (1) create initial 'nodes'
    //             std::vector<overlap_node_t> entries;
    //             for(size_t i=0;i<m_size;i++) {
    //                 overlap_node_t node;
    //                 auto start = m_offsets[i];
    //                 auto size = m_table[start];
    ...
    //             // (2) greedy merge nodes with largest overlap until no more overlap exists
    ...
    //         void prepare_for_encoding() {
    //             // compute greedy shortest superstring and update indexes
    //             compute_greedy_scs();
    ...
    //                             for (; (not found) and (base < entry_offset); base += max_entry_size)
    //                             {
    //                                 auto ptrptr = ptr;
    //                                 found = true;
